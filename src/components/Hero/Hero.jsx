    ...
    <section id="home" className={styles.container}>
      {isOn ? (
        ...
        <img
          ...
          src={
            isMobile
              ? "/assets/hero/herobgmobile.webp"
              : "/assets/hero/herobg.webp"
          }
          alt="hero image"
        />
      )}
      <a className={styles.herocta} href="mailto:prittam.work@gmail.com">
        <CustomButton />
      </a>
      <div className={styles.scrolltext}>
        * The name and images given in the project section are a replica of the
        actual app. Actual names and images of apps or logos can't be shared
        under strict NDAs.
      </div>
      <div className={styles.herosocials}>
        <a
          className={styles.herosocialsiconsemail}
        ...
        <a
          className={styles.herosocialsicons}
          href="https://in.linkedin.com/in/prittam3000"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg
        ...
        <a
          className={styles.herosocialsicons}
          href="https://github.com/SapphirePegasus/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg
        ...
        >
          ...
          <div className={styles.tooltip}>PayPal</div>
        </a>*/}
      </div>
    </section>
  );
